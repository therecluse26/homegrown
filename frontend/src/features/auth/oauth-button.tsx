...
// Brand-mandated colors for OAuth provider logos — these are official brand assets
// that must use provider-specified colors per brand guidelines, not design tokens.
