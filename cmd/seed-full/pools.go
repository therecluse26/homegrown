...
var groupTemplates = []groupTemplate{
	...
	{"Homeschool STEM Club", "Science, technology, engineering, and math projects for homeschool families. Monthly challenges!", "", "open"},
	{"Read-Aloud Recommendations", "Share and discover the best books for reading aloud with your family.", "", "open"},
	{"Homeschool Art Studio", "Art projects, picture study, and creative inspiration for homeschool families.", "", "open"},
	{"Latin & Languages Study Group", "For families studying Latin, Greek, or modern languages at home.", "", "open"},
	{"Homeschool Co-op Organizers", "Tips and strategies for starting and running successful homeschool co-ops.", "", "request_to_join"},
	{"Faith-Based Homeschooling", "Christian homeschool families sharing faith-centered curriculum and encouragement.", "", "open"},
	...
	{"Music & Movement", "Incorporating music education, movement, and performing arts into your homeschool.", "", "open"},
	{"Homeschool Gardeners", "Growing food, studying botany, and teaching life skills through gardening.", "", "open"},
	{"History Buffs", "Deep dives into historical periods, living history books, and timeline projects.", "", "open"},
	{"Math Without Tears", "Making math enjoyable for reluctant learners. Games, manipulatives, and real-world applications.", "", "open"},
	...
	{"Preschool at Home", "Early childhood activities, play-based learning, and pre-reading skills for the littlest learners.", "", "open"},
