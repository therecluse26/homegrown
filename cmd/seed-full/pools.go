...
var notifTemplates = []notifTemplate{
	...
	{"event_cancelled", "social", "Event Cancelled", "An event you RSVP'd to has been cancelled. Check your calendar for updates."},
	...
	{"milestone_achieved", "learning", "Milestone Achieved!", "A new learning milestone has been reached! View progress in the dashboard."},
	{"book_completed", "learning", "Book Completed!", "A new book has been completed. View the reading log for details."},
